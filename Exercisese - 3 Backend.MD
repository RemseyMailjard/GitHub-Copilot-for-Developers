...
> All exercises use the **Project 1 – Rabobank Case** back-end (Java 17, Spring Boot 3, H2).  
> Open the project folder `Project 1 - Rabobank case/backend/` in VS Code before you start.
...
```
Act as a senior Java developer at Rabobank. Test
